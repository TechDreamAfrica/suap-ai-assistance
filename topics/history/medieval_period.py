...
def medieval_period_page(page: ft.Page):
    """Medieval Period learning page"""
    page.title = f"Medieval Period - History Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Medieval Period concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Medieval Period concepts", size=14),
                    ft.Text(f"• Practice solving Medieval Period problems", size=14),
                    ft.Text(f"• Apply Medieval Period in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Medieval Period skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Medieval Period Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Medieval Period concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for Medieval Period", size=14),
