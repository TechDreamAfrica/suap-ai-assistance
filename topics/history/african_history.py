...
def african_history_page(page: ft.Page):
    """African History learning page"""
    page.title = f"African History - History Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about African History concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental African History concepts", size=14),
                    ft.Text(f"• Practice solving African History problems", size=14),
                    ft.Text(f"• Apply African History in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in African History skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to African History Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about African History concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for African History", size=14),
