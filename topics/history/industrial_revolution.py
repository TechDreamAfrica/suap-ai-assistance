...
def industrial_revolution_page(page: ft.Page):
    """Industrial Revolution learning page"""
    page.title = f"Industrial Revolution - History Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Industrial Revolution"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Industrial Revolution concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Industrial Revolution concepts", size=14),
                    ft.Text(f"• Practice solving Industrial Revolution problems", size=14),
                    ft.Text(f"• Apply Industrial Revolution in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Industrial Revolution skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Industrial Revolution Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Industrial Revolution concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for Industrial Revolution", size=14),
