...
def ancient_civilizations_page(page: ft.Page):
    """Ancient Civilizations learning page"""
    page.title = f"Ancient Civilizations - History Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Ancient Civilizations concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Ancient Civilizations concepts", size=14),
                    ft.Text(f"• Practice solving Ancient Civilizations problems", size=14),
                    ft.Text(f"• Apply Ancient Civilizations in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Ancient Civilizations skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Ancient Civilizations Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Ancient Civilizations concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for Ancient Civilizations", size=14),
