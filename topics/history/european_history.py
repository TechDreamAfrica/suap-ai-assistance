...
def european_history_page(page: ft.Page):
    """European History learning page"""
    page.title = f"European History - History Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("European History"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about European History concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental European History concepts", size=14),
                    ft.Text(f"• Practice solving European History problems", size=14),
                    ft.Text(f"• Apply European History in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in European History skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to European History Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about European History concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for European History", size=14),
