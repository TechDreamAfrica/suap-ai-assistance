...
def renaissance_page(page: ft.Page):
    """Renaissance learning page"""
    page.title = f"Renaissance - History Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Renaissance concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Renaissance concepts", size=14),
                    ft.Text(f"• Practice solving Renaissance problems", size=14),
                    ft.Text(f"• Apply Renaissance in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Renaissance skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Renaissance Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Renaissance concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for Renaissance", size=14),
