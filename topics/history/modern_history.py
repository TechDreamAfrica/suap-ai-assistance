...
def modern_history_page(page: ft.Page):
    """Modern History learning page"""
    page.title = f"Modern History - History Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Modern History concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Modern History concepts", size=14),
                    ft.Text(f"• Practice solving Modern History problems", size=14),
                    ft.Text(f"• Apply Modern History in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Modern History skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Modern History Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Modern History concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for Modern History", size=14),
