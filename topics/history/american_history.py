...
def american_history_page(page: ft.Page):
    """American History learning page"""
    page.title = f"American History - History Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("American History"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about American History concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental American History concepts", size=14),
                    ft.Text(f"• Practice solving American History problems", size=14),
                    ft.Text(f"• Apply American History in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in American History skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to American History Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about American History concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BROWN_900),
                    ft.Text(f"• Interactive learning for American History", size=14),
