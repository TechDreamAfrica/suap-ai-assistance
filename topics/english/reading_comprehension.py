...
def reading_comprehension_page(page: ft.Page):
    """Reading Comprehension learning page"""
    page.title = f"Reading Comprehension - English Learning"
    ...
    page.appbar = ft.AppBar(
        leading=ft.IconButton(
            ft.Icons.ARROW_BACK,
            on_click=lambda e: page.go("/english")
        ),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Reading Comprehension concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Reading Comprehension concepts", size=14),
                    ft.Text(f"• Practice solving Reading Comprehension problems", size=14),
                    ft.Text(f"• Apply Reading Comprehension in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Reading Comprehension skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Reading Comprehension Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Reading Comprehension concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Reading Comprehension", size=14),
