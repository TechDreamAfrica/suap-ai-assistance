...
def vocabulary_page(page: ft.Page):
    ...
    page.title = f"Vocabulary - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Vocabulary concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Vocabulary concepts", size=14),
                    ft.Text(f"• Practice solving Vocabulary problems", size=14),
                    ft.Text(f"• Apply Vocabulary in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Vocabulary skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Vocabulary Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Vocabulary concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Vocabulary", size=14),
