...
def creative_writing_page(page: ft.Page):
    """Creative Writing learning page"""
    page.title = f"Creative Writing - English Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Creative Writing"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Creative Writing concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Creative Writing concepts", size=14),
                    ft.Text(f"• Practice solving Creative Writing problems", size=14),
                    ft.Text(f"• Apply Creative Writing in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Creative Writing skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Creative Writing Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Creative Writing concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Creative Writing", size=14),
