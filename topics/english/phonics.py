...
def phonics_page(page: ft.Page):
    """Phonics learning page"""
    page.title = f"Phonics - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Phonics concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Phonics concepts", size=14),
                    ft.Text(f"• Practice solving Phonics problems", size=14),
                    ft.Text(f"• Apply Phonics in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Phonics skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Phonics Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Phonics concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Phonics", size=14),
