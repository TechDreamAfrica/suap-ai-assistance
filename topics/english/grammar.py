...
def grammar_page(page: ft.Page):
    """Grammar learning page"""
    page.title = f"Grammar - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Grammar concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Grammar concepts", size=14),
                    ft.Text(f"• Practice solving Grammar problems", size=14),
                    ft.Text(f"• Apply Grammar in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Grammar skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Grammar Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Grammar concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Grammar", size=14),
