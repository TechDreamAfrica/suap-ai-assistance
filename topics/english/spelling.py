...
def spelling_page(page: ft.Page):
    """Spelling learning page"""
    page.title = f"Spelling - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Spelling concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Spelling concepts", size=14),
                    ft.Text(f"• Practice solving Spelling problems", size=14),
                    ft.Text(f"• Apply Spelling in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Spelling skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Spelling Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Spelling concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Spelling", size=14),
