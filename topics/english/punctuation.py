...
def punctuation_page(page: ft.Page):
    """Punctuation learning page"""
    page.title = f"Punctuation - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Punctuation concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Punctuation concepts", size=14),
                    ft.Text(f"• Practice solving Punctuation problems", size=14),
                    ft.Text(f"• Apply Punctuation in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Punctuation skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Punctuation Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Punctuation concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Punctuation", size=14),
