...
def essay_writing_page(page: ft.Page):
    """Essay Writing learning page"""
    page.title = f"Essay Writing - English Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Essay Writing concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Essay Writing concepts", size=14),
                    ft.Text(f"• Practice solving Essay Writing problems", size=14),
                    ft.Text(f"• Apply Essay Writing in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Essay Writing skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Essay Writing Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Essay Writing concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.GREEN_900),
                    ft.Text(f"• Interactive learning for Essay Writing", size=14),
