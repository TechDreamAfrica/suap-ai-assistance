...
def trigonometry_page(page: ft.Page):
    """Trigonometry learning page"""
    page.title = f"Trigonometry - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Trigonometry concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Trigonometry concepts", size=14),
                    ft.Text(f"• Practice solving Trigonometry problems", size=14),
                    ft.Text(f"• Apply Trigonometry in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Trigonometry skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Trigonometry Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Trigonometry concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Trigonometry", size=14),
