...
def linear_functions_page(page: ft.Page):
    """Linear Functions learning page"""
    page.title = f"Linear Functions - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Linear Functions concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Linear Functions concepts", size=14),
                    ft.Text(f"• Practice solving Linear Functions problems", size=14),
                    ft.Text(f"• Apply Linear Functions in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Linear Functions skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Linear Functions Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Linear Functions concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Linear Functions", size=14),
