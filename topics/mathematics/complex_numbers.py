...
def complex_numbers_page(page: ft.Page):
    """Complex Numbers learning page"""
    page.title = f"Complex Numbers - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Complex Numbers concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Complex Numbers concepts", size=14),
                    ft.Text(f"• Practice solving Complex Numbers problems", size=14),
                    ft.Text(f"• Apply Complex Numbers in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Complex Numbers skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Complex Numbers Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Complex Numbers concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Complex Numbers", size=14),
