...
def geometry_page(page: ft.Page):
    """Geometry learning page"""
    page.title = f"Geometry - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Geometry concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Geometry concepts", size=14),
                    ft.Text(f"• Practice solving Geometry problems", size=14),
                    ft.Text(f"• Apply Geometry in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Geometry skills", size=14),
                ], spacing=10),
