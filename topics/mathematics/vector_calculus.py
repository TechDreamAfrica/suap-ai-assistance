...
def vector_calculus_page(page: ft.Page):
    """Vector Calculus learning page"""
    page.title = f"Vector Calculus - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Vector Calculus concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Vector Calculus concepts", size=14),
                    ft.Text(f"• Practice solving Vector Calculus problems", size=14),
                    ft.Text(f"• Apply Vector Calculus in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Vector Calculus skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Vector Calculus Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Vector Calculus concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Vector Calculus", size=14),
