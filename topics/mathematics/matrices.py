...
def matrices_page(page: ft.Page):
    """Matrices learning page"""
    page.title = f"Matrices - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Matrices concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Matrices concepts", size=14),
                    ft.Text(f"• Practice solving Matrices problems", size=14),
                    ft.Text(f"• Apply Matrices in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Matrices skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Matrices Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Matrices concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Matrices", size=14),
