...
def statistics_probability_page(page: ft.Page):
    """Statistics & Probability learning page"""
    page.title = f"Statistics & Probability - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Statistics & Probability concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Statistics & Probability concepts", size=14),
                    ft.Text(f"• Practice solving Statistics & Probability problems", size=14),
                    ft.Text(f"• Apply Statistics & Probability in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Statistics & Probability skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Statistics & Probability Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Statistics & Probability concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Statistics & Probability", size=14),
