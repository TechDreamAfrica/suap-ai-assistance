...
def number_theory_page(page: ft.Page):
    """Number Theory learning page"""
    page.title = f"Number Theory - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Number Theory concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Number Theory concepts", size=14),
                    ft.Text(f"• Practice solving Number Theory problems", size=14),
                    ft.Text(f"• Apply Number Theory in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Number Theory skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Number Theory Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Number Theory concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Number Theory", size=14),
