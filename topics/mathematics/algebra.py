...
def algebra_page(page: ft.Page):
    """Algebra learning page"""
    page.title = f"Algebra - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Algebra concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Algebra concepts", size=14),
                    ft.Text(f"• Practice solving Algebra problems", size=14),
                    ft.Text(f"• Apply Algebra in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Algebra skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Algebra Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Algebra concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Algebra", size=14),
