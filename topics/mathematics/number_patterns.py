...
def number_patterns_page(page: ft.Page):
    """Number Patterns learning page"""
    page.title = f"Number Patterns - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Number Patterns concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Number Patterns concepts", size=14),
                    ft.Text(f"• Practice solving Number Patterns problems", size=14),
                    ft.Text(f"• Apply Number Patterns in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Number Patterns skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Number Patterns Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Number Patterns concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Number Patterns", size=14),
