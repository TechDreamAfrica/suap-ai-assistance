...
def quadratic_equations_page(page: ft.Page):
    """Quadratic Equations learning page"""
    page.title = f"Quadratic Equations - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Quadratic Equations concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Quadratic Equations concepts", size=14),
                    ft.Text(f"• Practice solving Quadratic Equations problems", size=14),
                    ft.Text(f"• Apply Quadratic Equations in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Quadratic Equations skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Quadratic Equations Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Quadratic Equations concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Quadratic Equations", size=14),
