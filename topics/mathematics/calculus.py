...
def calculus_page(page: ft.Page):
    """Calculus learning page"""
    page.title = f"Calculus - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Calculus concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Calculus concepts", size=14),
                    ft.Text(f"• Practice solving Calculus problems", size=14),
                    ft.Text(f"• Apply Calculus in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Calculus skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Calculus Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Calculus concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Calculus", size=14),
