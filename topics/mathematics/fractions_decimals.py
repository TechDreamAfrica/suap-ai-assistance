...
def fractions_decimals_page(page: ft.Page):
    ...
    page.title = f"Fractions & Decimals - Mathematics Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Fractions & Decimals concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Fractions & Decimals concepts", size=14),
                    ft.Text(f"• Practice solving Fractions & Decimals problems", size=14),
                    ft.Text(f"• Apply Fractions & Decimals in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Fractions & Decimals skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Fractions & Decimals Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Fractions & Decimals concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.BLUE_900),
                    ft.Text(f"• Interactive learning for Fractions & Decimals", size=14),
