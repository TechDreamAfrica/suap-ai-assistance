...
def computer_hardware_page(page: ft.Page):
    """Computer Hardware learning page"""
    page.title = f"Computer Hardware - Computing Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Computer Hardware"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Computer Hardware concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Computer Hardware concepts", size=14),
                    ft.Text(f"• Practice solving Computer Hardware problems", size=14),
                    ft.Text(f"• Apply Computer Hardware in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Computer Hardware skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Computer Hardware Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Computer Hardware concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Computer Hardware", size=14),
