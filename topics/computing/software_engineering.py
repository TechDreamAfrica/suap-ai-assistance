...
def software_engineering_page(page: ft.Page):
    """Software Engineering learning page"""
    page.title = f"Software Engineering - Computing Learning"
    ...
    page.appbar = ft.AppBar(
        leading=ft.IconButton(
            ft.Icons.ARROW_BACK,
            on_click=lambda e: page.go("/computing")
        ),
        title=ft.Text("Software Engineering"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Software Engineering concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Software Engineering concepts", size=14),
                    ft.Text(f"• Practice solving Software Engineering problems", size=14),
                    ft.Text(f"• Apply Software Engineering in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Software Engineering skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Software Engineering Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Software Engineering concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Software Engineering", size=14),
