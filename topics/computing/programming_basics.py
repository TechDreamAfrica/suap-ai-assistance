...
def programming_basics_page(page: ft.Page):
    """Programming Basics learning page"""
    page.title = f"Programming Basics - Computing Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Programming Basics"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Programming Basics concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Programming Basics concepts", size=14),
                    ft.Text(f"• Practice solving Programming Basics problems", size=14),
                    ft.Text(f"• Apply Programming Basics in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Programming Basics skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Programming Basics Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Programming Basics concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Programming Basics", size=14),
