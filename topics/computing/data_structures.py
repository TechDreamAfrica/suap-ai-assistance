...
def data_structures_page(page: ft.Page):
    """Data Structures learning page"""
    page.title = f"Data Structures - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Data Structures concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Data Structures concepts", size=14),
                    ft.Text(f"• Practice solving Data Structures problems", size=14),
                    ft.Text(f"• Apply Data Structures in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Data Structures skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Data Structures Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Data Structures concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Data Structures", size=14),
