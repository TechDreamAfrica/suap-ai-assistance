...
def web_development_page(page: ft.Page):
    """Web Development learning page"""
    page.title = f"Web Development - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Web Development concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Web Development concepts", size=14),
                    ft.Text(f"• Practice solving Web Development problems", size=14),
                    ft.Text(f"• Apply Web Development in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Web Development skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Web Development Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Web Development concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Web Development", size=14),
