...
def algorithms_page(page: ft.Page):
    """Algorithms learning page"""
    page.title = f"Algorithms - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Algorithms concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Algorithms concepts", size=14),
                    ft.Text(f"• Practice solving Algorithms problems", size=14),
                    ft.Text(f"• Apply Algorithms in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Algorithms skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Algorithms Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Algorithms concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Algorithms", size=14),
