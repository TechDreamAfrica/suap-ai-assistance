...
def cybersecurity_page(page: ft.Page):
    """Cybersecurity learning page"""
    page.title = f"Cybersecurity - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Cybersecurity concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Cybersecurity concepts", size=14),
                    ft.Text(f"• Practice solving Cybersecurity problems", size=14),
                    ft.Text(f"• Apply Cybersecurity in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Cybersecurity skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Cybersecurity Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Cybersecurity concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Cybersecurity", size=14),
