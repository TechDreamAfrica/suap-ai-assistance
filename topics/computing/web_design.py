...
def web_design_page(page: ft.Page):
    """Web Design learning page"""
    page.title = f"Web Design - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Web Design concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Web Design concepts", size=14),
                    ft.Text(f"• Practice solving Web Design problems", size=14),
                    ft.Text(f"• Apply Web Design in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Web Design skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Web Design Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Web Design concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Web Design", size=14),
