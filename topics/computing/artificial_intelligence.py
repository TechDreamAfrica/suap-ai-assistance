...
def artificial_intelligence_page(page: ft.Page):
    """Artificial Intelligence learning page"""
    page.title = f"Artificial Intelligence - Computing Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Artificial Intelligence"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Artificial Intelligence concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Artificial Intelligence concepts", size=14),
                    ft.Text(f"• Practice solving Artificial Intelligence problems", size=14),
                    ft.Text(f"• Apply Artificial Intelligence in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Artificial Intelligence skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Artificial Intelligence Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Artificial Intelligence concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Artificial Intelligence", size=14),
