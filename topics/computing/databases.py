...
def databases_page(page: ft.Page):
    """Databases learning page"""
    page.title = f"Databases - Computing Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Databases concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Databases concepts", size=14),
                    ft.Text(f"• Practice solving Databases problems", size=14),
                    ft.Text(f"• Apply Databases in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Databases skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Databases Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Databases concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Databases", size=14),
