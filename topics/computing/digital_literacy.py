...
def digital_literacy_page(page: ft.Page):
    """Digital Literacy learning page"""
    page.title = f"Digital Literacy - Computing Learning"
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("Digital Literacy"),
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Digital Literacy concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Digital Literacy concepts", size=14),
                    ft.Text(f"• Practice solving Digital Literacy problems", size=14),
                    ft.Text(f"• Apply Digital Literacy in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Digital Literacy skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Digital Literacy Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Digital Literacy concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.PURPLE_900),
                    ft.Text(f"• Interactive learning for Digital Literacy", size=14),
