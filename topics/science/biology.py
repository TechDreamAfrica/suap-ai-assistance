...
def biology_page(page: ft.Page):
    """Biology learning page"""
    page.title = f"Biology - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Biology concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Biology concepts", size=14),
                    ft.Text(f"• Practice solving Biology problems", size=14),
                    ft.Text(f"• Apply Biology in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Biology skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Biology Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Biology concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Biology", size=14),
