...
def earth_science_page(page: ft.Page):
    """Earth Science learning page"""
    page.title = f"Earth Science - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Earth Science concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Earth Science concepts", size=14),
                    ft.Text(f"• Practice solving Earth Science problems", size=14),
                    ft.Text(f"• Apply Earth Science in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Earth Science skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Earth Science Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Earth Science concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Earth Science", size=14),
