...
def chemistry_page(page: ft.Page):
    """Chemistry learning page"""
    page.title = f"Chemistry - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Chemistry concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Chemistry concepts", size=14),
                    ft.Text(f"• Practice solving Chemistry problems", size=14),
                    ft.Text(f"• Apply Chemistry in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Chemistry skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Chemistry Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Chemistry concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Chemistry", size=14),
