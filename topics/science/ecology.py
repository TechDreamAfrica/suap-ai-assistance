...
def ecology_page(page: ft.Page):
    """Ecology learning page"""
    page.title = f"Ecology - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Ecology concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Ecology concepts", size=14),
                    ft.Text(f"• Practice solving Ecology problems", size=14),
                    ft.Text(f"• Apply Ecology in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Ecology skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Ecology Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Ecology concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Ecology", size=14),
