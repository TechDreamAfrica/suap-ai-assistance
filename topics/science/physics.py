...
def physics_page(page: ft.Page):
    ...
    page.title = f"Physics - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Physics concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Physics concepts", size=14),
                    ft.Text(f"• Practice solving Physics problems", size=14),
                    ft.Text(f"• Apply Physics in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Physics skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Physics Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Physics concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Physics", size=14),
