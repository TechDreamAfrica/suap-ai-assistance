...
def scientific_method_page(page: ft.Page):
    ...
    page.title = f"Scientific Method - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Scientific Method concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Scientific Method concepts", size=14),
                    ft.Text(f"• Practice solving Scientific Method problems", size=14),
                    ft.Text(f"• Apply Scientific Method in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Scientific Method skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Scientific Method Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Scientific Method concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Scientific Method", size=14),
