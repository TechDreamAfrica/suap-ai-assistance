...
def genetics_page(page: ft.Page):
    """Genetics learning page"""
    page.title = f"Genetics - Science Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Genetics concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Genetics concepts", size=14),
                    ft.Text(f"• Practice solving Genetics problems", size=14),
                    ft.Text(f"• Apply Genetics in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Genetics skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Genetics Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Genetics concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.TEAL_900),
                    ft.Text(f"• Interactive learning for Genetics", size=14),
