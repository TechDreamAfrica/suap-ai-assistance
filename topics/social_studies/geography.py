...
def geography_page(page: ft.Page):
    """Geography learning page"""
    page.title = f"Geography - Social Studies Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Geography concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Geography concepts", size=14),
                    ft.Text(f"• Practice solving Geography problems", size=14),
                    ft.Text(f"• Apply Geography in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Geography skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Geography Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Geography concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.ORANGE_900),
                    ft.Text(f"• Interactive learning for Geography", size=14),
