...
def culture_page(page: ft.Page):
    """Culture learning page"""
    page.title = f"Culture - Social Studies Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Culture concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Culture concepts", size=14),
                    ft.Text(f"• Practice solving Culture problems", size=14),
                    ft.Text(f"• Apply Culture in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Culture skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Culture Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Culture concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.ORANGE_900),
                    ft.Text(f"• Interactive learning for Culture", size=14),
