...
def civics_page(page: ft.Page):
    ...
    page.title = f"Civics - Social Studies Learning"
    ...
    content = ft.Container(
        ft.Column([
            ...
            ft.Text(
                f"Learn about Civics concepts and practice problems",
                size=16,
            ...
            ft.Container(
                ft.Column([
                    ...
                    ft.Text(f"• Master fundamental Civics concepts", size=14),
                    ft.Text(f"• Practice solving Civics problems", size=14),
                    ft.Text(f"• Apply Civics in real-world scenarios", size=14),
                    ft.Text(f"• Build confidence in Civics skills", size=14),
                ], spacing=10),
            ...
            ft.Container(
                ft.Column([
                    ft.Text(f"Welcome to Civics Learning!", size=18, weight=ft.FontWeight.BOLD),
                    ft.Text(f"This is where you'll learn about Civics concepts. Click the buttons above to get started with practice quizzes, help, or see examples.", size=14),
                    ft.Text("✨ Features:", size=16, weight=ft.FontWeight.BOLD, color=ft.Colors.ORANGE_900),
                    ft.Text(f"• Interactive learning for Civics", size=14),
